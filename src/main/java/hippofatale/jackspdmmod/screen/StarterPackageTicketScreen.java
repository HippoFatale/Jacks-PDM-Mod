...
import hippofatale.jackspdmmod.networking.packet.StarterPackageTicketSelectC2SPacket;
...
public class StarterPackageTicketScreen extends Screen {
    private ITextComponent title = new TranslationTextComponent("item.jackspdmmod.starter_package_ticket");
    ...
    protected void init() {
        ...
        this.addButton(new Button(this.width / 2 - buttonWidth - 5, this.height / 2, buttonWidth, buttonHeight,
        ...
        this.addButton(new Button(this.width / 2 + 5, this.height / 2, buttonWidth, buttonHeight,
    ...
    public void render(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
        drawCenteredString(p_230430_1_, this.font, title, this.width / 2, this.height / 2 - 20, 16777215);
