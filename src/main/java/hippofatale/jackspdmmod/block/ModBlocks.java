package hippofatale.jackspdmmod.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> PERSONAL_SMALL_PLACARD_BLOCK = registerBlock("personal_small_placard",
            () -> new PlacardBlock(AbstractBlock.Properties.of(Material.WOOD), HomeType.PERSONAL, HomeSize.SMALL, new BigDecimal("100000.0"), WoodType.BIRCH));
